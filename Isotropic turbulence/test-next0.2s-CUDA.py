...
#"C:/Users/Javad Mortazavian/anaconda3/envs/torch_gpu/python.exe" "c:/Users/Javad Mortazavian/Documents/GitHub/cis694_turbulence/test-next0.2s-CUDA.py"
import numpy as np
...
seq_len = 3
forecast_gap = 50  # since dt=0.01s, 0.2s = 20 steps
...
# === Train Model ===
model = ConvTransformer(seq_len).to(device)
